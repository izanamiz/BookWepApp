...
//import com.project.book.logging.LoggingFilter;
import com.project.book.util.CustomHttpServletRequestWrapper;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    @Override
    //được gọi mỗi khi một request đến server và nó được dùng để xử lý các yêu cầu được gửi đến một URL cụ thể. doFilterInternal() nhận vào đối số là HttpServletRequest và HttpServletResponse để cho phép ta thực hiện các xử lý và trả về kết quả cho client.
